...
def main():
    ...
    print("reading data .....")    
    plot_image("/Users/crowledj/Code/kaggle/TSA/sample/00360f79fd6e02781457eda48f85da90.aps")
    print("Done reading data !")  
       
    

#this defines the file as including the main file of the entire program :
